...
2. **Add to constants.js** in appropriate category
...
2. **Constants not found**: Verify path exists in constants.js
3. **Element not found**: Check selector is correct
4. **Loading order**: Ensure constants.js loads before text-manager.js
