...
const CONSTANTS = {
	...
	GAME_CONFIG: {
		...
		ACTUAL_MAX_LEVEL: 16, // Actual final level of the game (auto-detected, see script/levels/update-max-level.js)
		LEVEL_HASH_SEED: '', // Hash seed for level filename generation (empty = development mode)
